...
import {CLOTHES_TYPES, GOODS_IS_BESTSELLER, GOODS_IS_NEW, GOODS_POPULARITY} from "../../../constants/goodsTypes";
import {ADULT_SIZES_LIST, KIDS_SIZES_LIST} from "../../../constants/goods";
...
export const KidsForm = ({type, handleSelectType, maxImagesCount}: IBaseFormProps) => (
    <TabbedForm>
