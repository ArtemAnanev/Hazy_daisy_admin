import {useDataProvider, useGetOne, useGetRecordId, useNotify, useRedirect} from "react-admin";
...
export const useGoodsEdition = (sourceName: string) => {
    ...
    const {type, handleSelectType, maxImagesCount, setType} = useGoodsCreation(CLOTHES_TYPES)
    ...
    return {handleSelectType, maxImagesCount, type, handleClone, cloneProductSpinner}
}
